class Currency:
  ...
  """
  # ARAZ'S VALUES
  currencies =  {'CHF': 0.987654321, #swiss franc 
                 'CAD': 1.123456789, #canadian dollar
                 'GBP': 0.777777777, #british pound
                 'JPY': 111.1111111, #japanese yen
                 'EUR': 0.888888888, #euro
                 'USD': 1.0} #us dollar
  """
  ...
  def __radd__(self,other):
    # This method is similar to __add__(self,other)
    # , but occurs when an int or float tries to add a Currency object.
